...
-   The DataFrame contains a "category\_id" column that has entries going sequentially from "cat1" to "cat_n_", where _n_ is the number of unique categories (5 points)
